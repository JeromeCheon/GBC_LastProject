	...
	<div class="cd-timeline-block" style="vertical-align :middle;
		...
		<div class="cd-timeline-content" style="vertical-align :middle;
           ...
           function expandTable($content){
              ...
              $html .= nl2br($content)."</td></tr><a href=\"#\" class=\"cd-read-more\">Read more</a>
              </div><br>";
...
-->
    ...
    <tr>
    	...
    	<input type="file" name="upload" accept = "image/jpg, image/gif"/>
